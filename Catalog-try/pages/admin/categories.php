...
<form class="form-horizontal" role="form" method="post" action="api/legacy/admin/category-add.php">
...
<?php foreach($categories as $cat):?>
                        <tr>
                        <td style="width:30px;">
                          <a href="../?view=products&cat=<?php echo $cat->short_name; ?>" target="_blank" class="btn btn-default btn-xs"><i class="fa fa-eye"></i></a>
                        </td>
  ...
  <div class="modal fade" id="myModal-<?php echo $cat->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
<form class="form-horizontal" role="form" method="post" action="api/legacy/admin/category-update.php">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Nombre</label>
    <div class="col-lg-10">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="category_id" value="<?php echo $cat->id; ?>">
      <button type="submit" class="btn btn-block btn-success">Actualizar Categoria</button>
                        ...
                        <a href="api/legacy/admin/category-delete.php&category_id=<?php echo $cat->id; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a> 
                        </td>
                        </tr>
<?php endforeach; ?>
                      </tbody>
